  ...
  return (
      <section className="min-h-screen bg-pattern-green bg-repeat z-[0] flex">
        ...
        <div className="flex flex-row flex-wrap justify-center items-center content-center">
          ...
          <div className="flex justify-center flex-col text-white mb-[10%]">
            <div className="font-alstoria lg:text-[54px] sm:text-[32px] text-[16px]">Selamat Datang </div>
            <div className="font-alstoria lg:text-[102px] sm:text-[61px] text-[30px]"> Kesatria Muda</div>
            <div className="font-creato lg:text-[54px] font-[1000] sm:text-[32px] text-[16px]">2023 !</div>
          </div>
        </div>
