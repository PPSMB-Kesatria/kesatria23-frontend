    ...
    <section className="min-h-screen text-neutral-100 py-10 md:py-20 relative bg-pattern-green bg-contain bg-repeat flex gap-[35px] justify-center items-center flex-col">
      ...
      <div className="z-[100]">
        ...
        <Swiper
          slidesPerView={1}
          spaceBetween={10}
          className="w-[290px] sm:w-[576px] lg:w-[920px] 2xl:w-[1020px] !overflow-y-visible !px-[10px] bg-green-100 rounded-lg"
          grabCursor={true}
          onSwiper={setSwiper}
...
function Imagecard() {
  ...
  return (
    <div className="flex flex-col lg:flex-row ml-[20px] sm:rounded-[40px] sw-fit items-center  sm:py-10 2xl:py-12 !mx-auto">
